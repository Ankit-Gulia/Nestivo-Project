    ...
    <div className="min-h-screen bg-[#fffdf8] px-4 py-6 sm:px-6 lg:px-8">
      <div className="mx-auto grid max-w-6xl overflow-hidden rounded-[36px] border border-slate-200 bg-white shadow-[0_30px_120px_-50px_rgba(15,23,42,0.55)] lg:grid-cols-[1.05fr_0.95fr]">
        <section className="relative hidden overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-rose-950 p-8 text-white lg:flex lg:flex-col lg:justify-between">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(244,63,94,0.24),_transparent_26%),radial-gradient(circle_at_bottom_right,_rgba(14,116,144,0.18),_transparent_24%)]" />
          <div className="relative z-10">
            ...
            <p className="mt-5 text-4xl font-black tracking-tight">Build your next stay story.</p>
            <p className="mt-3 max-w-md text-sm text-white/70">
              Create an account to save favorite homes, follow premium listings, and connect with trusted hosts across beautifully curated stays.
            </p>
          </div>
            ...
            {[
              {
                ...
                detail: "Every stay is carefully curated with premium comfort and local character.",
              },
              {
                title: "Flexible planning",
                detail: "Browse, compare, and book effortlessly with a modern booking flow.",
              },
              {
                title: "Trusted community",
                detail: "Join a guest-focused platform designed for memorable escapes.",
              },
            ].map((item) => (
        ...
        <section className="p-6 sm:p-8 lg:p-10">
          <div className="mx-auto max-w-md">
            ...
            <div className="mt-8">
              ...
              <h1 className="mt-2 text-4xl font-black tracking-tight text-slate-900">Start your journey</h1>
              <p className="mt-2 text-sm text-slate-600">
                Join thousands of travelers discovering design-led stays with thoughtful service.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-4">
              ...
              <div>
                <label className="mb-2 block text-sm font-semibold text-slate-700" htmlFor="full_name">
                  Full Name
                </label>
                <input
                  id="full_name"
            ...
            <div className="mt-6 rounded-[26px] border border-slate-200 bg-white p-4 text-sm text-slate-600">
              Already have an account? <Link to="/login" className="font-bold text-rose-600">Sign in here</Link>.
            </div>
          </div>
        </section>
      </div>
